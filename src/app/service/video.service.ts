...
export class VideoService {
 videoData = [
  {
   id: '1',
   title: ' Хүрлийн үеийн нүүдэлчдийн хэрэглэж байсан эртний ЦУТГУУРЫН ЧУЛУУН ХЭВ илрүүлжээ',
  ...
  {
   id: '3',
   title: 'Sogoo’s podcast: Археологич, доктор, Шинжлэх ухааны гавьяат зүтгэлтэн Диймаажавын Эрдэнэбаатар',
 ...
 getAllVideo(lang = 'mn'): Observable<any> {
