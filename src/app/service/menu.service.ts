...
export class MenuService {
      ...
      subtitle: [
        {
          id: 1,
          type: 1,
          info: '    "info": "<ul style="list-style-type:square;">\r\n\t<li>\r\n\t<h1><img alt="" src="https://sodtech.mn/ardour-backend/images/product/Screenshot_2024-08-07_143348.png" style="width: 480px; height: 600px;" /><img alt="" src="https://sodtech.mn/ardour-backend/images/product/Screenshot_2024-08-07_163605.png" style="width: 480px; height: 600px;" /><span style="font-size:11px;"><img alt="" class="left" src="https://sodtech.mn/ardour-backend/images/product/Screenshot_2024-08-07_163605.png" style="width: 480px; height: 600px;" /></span></h1>\r\n\t</li>\r\n\t<li>\r\n\t<h1>Ширээний тавцан трапец хэлбэртэй</h1>\r\n\t</li>\r\n\t<li>\r\n\t<h2>Зориулалтын PVC эмжээрэн хүрээтэй</h2>\r\n\t</li>\r\n\t<li>\r\n\t<h2>Сайн чанарын будаг, бат бөх төмөр хөлтэй</h2>\r\n\t</li>\r\n\t<li>\r\n\t<h2>Ширээг олон хэлбэрээр нийлүүлж байрлуулан ашиглах боломжтой</h2>\r\n\t</li>\r\n\t<li>\r\n\t<h2>Ширээнүүдийг xооронд нь холбох түгжээтэй</h2>\r\n\t</li>\r\n\t<li>\r\n\t<h1>Зөөж хураахад хялбар бөгөөд тоормоз бүхий сайн чанарын дугуйтай</h1>\r\n\t</li>\r\n</ul>\r\n",',
          title: 'Greeting',
          path: '/',
        },
        {
  ...
  menulist(): Observable<any> {
    return this.http.get(`${environment.apiUrl}/menu/mn
      `);
  }
}
